document.addEventListener('DOMContentLoaded', () => {
    ...
    if (missionContent) {
        ...
        missionContent.style.transform = 'translateX(-30px)';
        missionContent.style.transition = 'opacity 0.8s ease-out, transform 0.8s ease-out';
    ...
    if (visionCard) {
        ...
        visionCard.style.transition = 'opacity 0.8s ease-out, transform 0.8s ease-out';
    ...
    const commitmentContent = document.querySelector('.commitment-content');
    if (commitmentContent) {
        commitmentContent.style.opacity = '0';
        commitmentContent.style.transform = 'translateY(30px)';
        commitmentContent.style.transition = 'opacity 0.8s ease-out, transform 0.8s ease-out';
        observer.observe(commitmentContent);
    }
